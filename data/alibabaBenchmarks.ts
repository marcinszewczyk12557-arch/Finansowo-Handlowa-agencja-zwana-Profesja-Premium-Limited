...
export const alibabaBenchmarks: AlibabaBenchmark[] = [
  ...
  },
  {
    ...
    note: 'Aktualne publiczne listingi Gree/Haier VRF przy MOQ 1 nadal mieszczą się mniej więcej w zakresie 899–1 769 USD dla urządzeń/systemów bazowych. Pełne realizacje z montażem i uruchomieniem wyceniać projektowo. Cenę PROFESJA liczyć dopiero po ustaleniu porównywalnego kompletnego zakresu UE.',
    checkedAt: '2026-08-11'
  },
  {
    ...
    note: 'Aktualne zestawy executive przy MOQ 1 nadal występują mniej więcej w zakresie 428–1 913 USD; niższe biurka/workstation nie są traktowane jako porównywalny luksusowy komplet. Docelowy przedział PROFESJA jest liczony jako 72–84% porównywalnego rynku UE, przy osobnej kontroli kosztu landed i zakresu zestawu.',
    checkedAt: '2026-08-11'
  },
  {
    category: 'Energia i Fotowoltaika — 20 kWp + magazyn 20 kWh',
    reference: '20 kWp PV + magazyn ok. 20–24 kWh, falownik hybrydowy, komplet komponentów i dokumentacja do rynku UE',
    ...
    comparableEuMarketPln: [109000, 204000],
    targetSalePln: [78500, 171400],
    note: 'Istotna korekta jakości benchmarku: odrzucono niskie listingi 20 kW bez potwierdzonego magazynu 20 kWh. Publiczne oferty z baterią/lithium i pełniejszym zakresem są bliżej ok. 5 200–8 500 USD. Europejski benchmark dla instalacji 20 kWp z magazynem ok. 20–24 kWh wynosi ok. 25,2–47,2 tys. EUR; przed ofertą obowiązkowo potwierdzić BOM, realną pojemność baterii, falownik, panele, gwarancję, Incoterms, logistykę i zgodność UE.',
    checkedAt: '2026-08-11'
  }
];
