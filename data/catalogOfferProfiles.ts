export type OfferProfile = {
  ...
  manualUrl: string;
  videoUrl: string;
  alibabaReferenceUrl?: string;
  ownerSupplierUrl?: string;
};
...
export const smartphoneProfiles: OfferProfile[] = [
  {
    ...
    warrantyMonths: 24,
    manualUrl: 'https://eu.nubia.com/pages/nubia-z80-ultra',
    videoUrl: 'https://www.nubia.com/en/products/smartphones/nubia/nubia-z80-ultra.html',
    alibabaReferenceUrl: 'https://www.alibaba.com/wholesale/nubia-smartphone.html',
  },
  {
    brand: 'nubia',
    model: 'Z70 Ultra',
    series: 'Flagship / foto',
    ...
    warrantyMonths: 24,
    manualUrl: 'https://eu.nubia.com/en-de/pages/nubia-z70-ultra',
    videoUrl: 'https://eu.nubia.com/en-de/pages/nubia-z70-ultra',
    alibabaReferenceUrl: 'https://www.alibaba.com/wholesale/nubia-smartphone.html',
  },
  {
    brand: 'REDMAGIC',
    ...
    warrantyMonths: 24,
    manualUrl: 'https://eu.redmagic.gg/products/redmagic-11-pro/',
    videoUrl: 'https://eu.redmagic.gg/products/redmagic-11-pro/',
    alibabaReferenceUrl: 'https://www.alibaba.com/wholesale/redmagic-smartphone.html',
  },
  {
    brand: 'REDMAGIC',
    model: '10 Pro',
    ...
    warrantyMonths: 24,
    manualUrl: 'https://eu.redmagic.gg/products/redmagic-10-pro',
    videoUrl: 'https://eu.redmagic.gg/products/redmagic-10-pro',
    alibabaReferenceUrl: 'https://www.alibaba.com/wholesale/redmagic-smartphone.html',
  },
  {
    brand: 'REDMAGIC',
    model: '10 Air',
    series: 'Gaming / mobilny',
    ...
    warrantyMonths: 24,
    manualUrl: 'https://eu.redmagic.gg/products/redmagic-10-air',
    videoUrl: 'https://eu.redmagic.gg/products/redmagic-10-air',
    alibabaReferenceUrl: 'https://www.alibaba.com/wholesale/redmagic-smartphone.html',
  },
  {
    brand: 'Apple',
    ...
    warrantyMonths: 12,
    manualUrl: 'https://support.apple.com/pl-pl/docs/iphone',
    videoUrl: 'https://www.apple.com/pl/iphone/',
    alibabaReferenceUrl: 'https://www.alibaba.com/showroom/iphone.html',
  },
  {
    brand: 'Apple',
    model: 'iPhone 17',
  ...
  },
  {
    ...
    warrantyMonths: 12,
    manualUrl: 'https://www.samsung.com/pl/support/',
    videoUrl: 'https://www.samsung.com/pl/smartphones/',
    alibabaReferenceUrl: 'https://www.alibaba.com/showroom/samsung-galaxy-phone.html',
  },
  {
    brand: 'Samsung',
...
export const ownerSupplierLinkNotice = 'Faktyczny link do konkretnej oferty / producenta Alibaba jest przypisywany przez właściciela oferty po osobistej weryfikacji dostawcy, SKU, MOQ, gwarancji, zgodności i aktualnej dostępności.';
