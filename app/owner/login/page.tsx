...
export default async function OwnerLogin({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <main className="section" style={{ maxWidth: 560, paddingTop: 80 }}>
      ...
      {!configured && <div className="card"><strong>Wymagana konfiguracja Vercel</strong><p>Ustaw zmienne środowiskowe OWNER_EMAIL, OWNER_PASSWORD i OWNER_SESSION_SECRET w projekcie Vercel, a następnie wykonaj redeploy.</p></div>}
