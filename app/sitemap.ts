...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const now = new Date();
  const publicPages = [
    '', '/catalog', '/catalog/fotowoltaika', '/catalog/smartfony-premium',
    '/sklepy/02-laptopy-komputery-mobilne', '/sklepy/03-komputery-stacjonarne-mini-pc',
    '/sklepy/04-monitory-wyswietlacze', '/sklepy/05-serwery-infrastruktura-it',
