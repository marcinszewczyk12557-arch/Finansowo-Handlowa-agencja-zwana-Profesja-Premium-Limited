  ...
  return (
    <>
      ...
      <main className="section legal-page">
        ...
        <p>Dane są wykorzystywane do rejestracji i obsługi zapytań B2B, przygotowania ofert, prowadzenia korespondencji, tworzenia i realizacji zamówień, przygotowania dokumentów handlowych oraz obsługi dostawy i statusu realizacji.</p>

        <h2>Przechowywanie w systemie</h2>
        <p>Zapytania i zamówienia mogą być zapisywane w produkcyjnej bazie danych PostgreSQL. Dostęp do danych operacyjnych po stronie administracyjnej jest ograniczony do chronionej strefy OWNER.</p>
