      ...
      <main className="premium-home">
        <section className="commerce-hero">
          ...
          <div className="product-stage" aria-label="Wybrane produkty premium">
            ...
            <div className="featured-stage-photo"><img src={redmagicFeaturedOffers[1].image} alt="REDMAGIC — wybrana oferta" /></div>
          ...
          <aside className="commerce-hero__offer">
            ...
            <div className="nubia-word">nubia</div><div className="redmagic-mark">REDMAGIC</div>
            ...
            <div className="trade-box"><h3>WARUNKI HANDLOWE B2B</h3><div className="trade-grid"><div><small>MINIMALNE ZAMÓWIENIE</small><strong>14 szt.</strong><span>wybrane oferty smartfonów</span></div><div><small>MINIMALNA WARTOŚĆ</small><strong>95 000 zł</strong><span>zamówienia B2B</span></div></div></div>
          </aside>
        </section>
        ...
        <section className="section featured-offers-section">
          ...
          <h2>5 wybranych ofert — ceny skorygowane o 19%</h2>
            ...
            {redmagicFeaturedOffers.map((offer, index) => (
              <article className="featured-offer-card" key={offer.title}>
                ...
                <div className="featured-offer-copy">
                  ...
                  <p><strong>Prezentacja:</strong> materiał produktowy PL/EN z prezentacją funkcji.</p>
                  <p><strong>Instrukcja:</strong> instrukcja obsługi i dokumentacja bezpieczeństwa dla zatwierdzonego wariantu.</p>
                  <strong className="featured-price">{pln(offer.price)}</strong><small>cena po obniżeniu o 19% względem poprzedniej ceny katalogowej</small>
        ...
        <section className="category-section">
          ...
          <div className="category-ribbon">{categories.map(([name, sub, icon]) => <Link href="/catalog" className="category-tile" key={name}><div className="category-visual">{icon}</div><strong>{name}</strong><span>{sub}</span></Link>)}</div>
        </section>

        <section className="trust-strip">
          <div><b>01</b><strong>BEZPIECZNE TRANSAKCJE</strong><span>Sprawdzane warunki i dokumentacja</span></div>
          <div><b>02</b><strong>CENY KATALOGOWE</strong><span>Skorygowane ceny sprzedażowe B2B</span></div>
        ...
        <section className="section premium-contact-block"><div><p className="eyebrow">Profesja Premium Limited</p><h2>Pełna wielopoziomowa struktura katalogu B2B</h2><p>18 kategorii głównych, 288 szczegółowych elementów katalogu i łącznie 1 440 pozycji produktowych — po pięć różnych produktów w każdym najniższym elemencie kategorii.</p></div><div className="cta-row"><Link href="/catalog"><button>Przejdź do pełnego katalogu</button></Link><Link href="/offers/new"><button className="cta-secondary">Złóż zapytanie B2B</button></Link></div></section>
      </main>
      <Footer />
    </>
  );
